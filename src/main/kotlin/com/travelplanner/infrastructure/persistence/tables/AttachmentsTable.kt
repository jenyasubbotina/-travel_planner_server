...
object AttachmentsTable : Table("attachments") {
    ...
    val expenseId = uuid("expense_id").references(ExpensesTable.id, onDelete = ReferenceOption.SET_NULL).nullable()
    val uploadedBy = uuid("uploaded_by").references(UsersTable.id, onDelete = ReferenceOption.CASCADE)
